...
<style lang="scss">
  #bjy-lottery {
    .bjy-lottery-content {
      ...
      input, .bjy-transfer-list-header-title, .bjy-transfer-action, .bjy-text, .bjy-checkbox-label span {
        color: #fff;
      }
      .bjy-left-more-tip, .bjy-tip{
        color: #9FA8B5;
      }
      .bjy-menu, .bjy-item {
      ...
      .bjy-select-dropdown > .bjy-button:hover:before {

  ...
  5: function (e, t, n) {
    var r = n(3),
      ...
      E = function (e, t, n) {
        ...
        for (a in p && (n = t), n)(c = !f && R && void 0 !== R[a]) && u(I, a) || (s = c ? R[a] : n[a], I[a] = p && "function" != typeof R[a] ? n[a] : T && c ? o(s, r) : l && R[a] == s ? function (e) {
        ...
        }(s) : A && "function" == typeof s ? o(Function.call, s) : s, A && ((I.virtual || (I.virtual = {}))[a] = s, e & E.R && P && !P[a] && _(P, a, s)))
      };
  ...
  752: function (e, t, n) {
    ...
    function I() {
      var e = i.get("user"),
        t = e.videoOn,
        n = e.audioOn;
      t || a.getCameraList().length > 0 && r.canOpenCameraWhenSpeaking && r.canOpenCameraWhenSpeaking() && (t = !0), n || a.getMicList().length > 0 && (n = !0), c.trigger(c.MEDIA_CONTROL_TRIGGER, {
        audioOn: n,
        videoOn: t
      })
    }
    _.messageTypes.media_remote_control_res = function (e, t) {
      var n = u.find(e);
      n.videoOn || n.audioOn || !t.video_on && !t.audio_on || c.trigger(c.SPEAK_INVITE_RESULT_FORCE, {
        user: n
      })
    };
        ...
        if (!S) return p = !0,
          function (e) {
            l(), f = setTimeout((function () {
              f = null, c.trigger(c.SPEAK_APPLY_RESULT_TIMEOUT), t.cancelApply()
            }), e)
          }(e), c.trigger(c.SPEAK_APPLY_REQ_TRIGGER), !0;
        t.processInvite(!0)
      }
    };
      ...
      if (n) {
        if (t) {
          ...
          c.on(c.SPEAK_APPLY_ACCEPT_RESULT + i, (function (e, t) {
            n.id === t.userId && (c.off(i), t.success ? r.resolve() : r.reject(), clearTimeout(_))
          }))
        } else r.resolve();
    ...
    function P(e) {
      var t = -1;
      return Yox.array.each(A, (function (n, r) {
    ...
    t.stopSpeak = function (e) {
      var t = u.find(e);
      if (t) return c.trigger(c.MEDIA_REMOTE_CONTROL_TRIGGER, {
        user: t,
        videoOn: !1,
        audioOn: !1,
    ...
    t.startInvite = function (e, n, i) {
      var _ = P(e);
      if (!(_ >= 0)) return t.isInviting(e) ? void 0 : (n ? function (e) {
        var t = u.find(e);
        c.trigger(c.MEDIA_REMOTE_CONTROL_TRIGGER, {
          user: t,
          audioOn: !0,
          videoOn: !!r.canOpenCameraWhenSpeaking && !!r.canOpenCameraWhenSpeaking(t.type),
          speakState: o.SPEAK_STATE_FREE
        })
      }(e) : (v(e, i), c.trigger(c.SPEAK_INVITE_REQ_TRIGGER, {
        to: e,
        invite: 1
      })), !0);
      c.trigger(c.SPEAK_APPLY_RES_TRIGGER, {
    ...
    function R(e) {
      var t = -1;
      return Yox.array.each(T, (function (n, r) {
    ...
    function v(e, t) {
      var n = {
        ...
        timer: setTimeout((function () {
          L(n), n.timer = null;
          var t = u.find(e);
          t && c.trigger(c.SPEAK_INVITE_RESULT_TIMEOUT, {
            user: t
          })
        }), t)
      };
      T.push(n), c.trigger(c.SPEAK_INVITING_ADD, {
        user: u.find(e)
      })
    }

    function d(e) {
      e.timer && (clearTimeout(e.timer), e.timer = null), Yox.array.remove(T, e), c.trigger(c.SPEAK_INVITING_REMOVE, {
        user: u.find(e.userId)
      })
    }

    function L(e, t) {
      d(e), t || c.trigger(c.SPEAK_INVITE_REQ_TRIGGER, {
        to: e.userId,
        invite: 0
      })
    }
    ...
    t.init = function (e) {
      t.init = $.noop, c.on(c.CLASS_END, (function () {
        p && t.cancelApply(), Yox.array.each(T, L)
      })).on(c.MEDIA_CONTROL_TRIGGER, (function (e, t) {
        var n = s(t.videoOn),
          r = s(t.audioOn);
        n && !a.getCameraList().length && (n = !1), r && !a.getMicList().length && (r = !1),
          function (e, t, n) {
            var r = function () {
            ...
            if (e || t) i.get("class.speakState") !== o.SPEAK_STATE_FREE && i.set("class.speakState", o.SPEAK_STATE_FREE), r();
            else {
              var _ = BJY.Player && BJY.Player.instances[i.get("user.id")];
              _ && _.isScreenSharing ? c.one(c.SCREEN_SHARE_STOP, (function (e, t) {
                r(), i.get("class.isFree") || i.set("class.speakState", o.SPEAK_STATE_LIMIT)
              })).trigger(c.SCREEN_SHARE_STOP_TRIGGER) : (r(), i.get("class.isFree") || i.set("class.speakState", o.SPEAK_STATE_LIMIT))
            }
          }(n, r)
        ...
        var n = t.user,
          r = n.id,
          i = R(r);
        i >= 0 && d(T[i]), (i = P(r)) >= 0 && (A.splice(i, 1), c.trigger(c.SPEAK_APPLYING_REMOVE, {
          user: n
        }))
      })).on(c.MEDIA_SWITCH_TRIGGER, (function (e, t) {
        var n = t.operator,
          r = i.get("user");
        n && n.id !== r.id && (r.videoOn || r.audioOn || !t.videoOn && !t.audioOn || c.trigger(c.SPEAK_INVITE_RES_TRIGGER, {
          accept: !0,
          force: !0
        }))
        ...
        var r = n.user;
        t.isApplying(r.id) || (u.add(r), t.isInviting(r.id) ? t.processApply(r.id, !0) : (r = u.find(r.id), A.push(r), r.isApplyingSpeak = !0, c.trigger(c.SPEAK_APPLYING_ADD, {
          user: r
        })))
        ...
        if (r.isSelf(n))
          if (r.isSelf(_)) c.trigger(c.SPEAK_APPLY_RESULT_CANCEL);
            ...
            i === o.SPEAK_STATE_FREE ? (c.trigger(c.SPEAK_APPLY_RESULT_ACCEPT, E), BJY.userSpeak.onApplyAccept ? BJY.userSpeak.onApplyAccept() : I()) : c.trigger(c.SPEAK_APPLY_RESULT_REJECT, E)
          }
        else {
          var a = P(n);
          ~a && (A.splice(a, 1), u.find(n).isApplyingSpeak = !1, c.trigger(c.SPEAK_APPLYING_REMOVE, {
            user: t.user,
            speakState: i
          }))
        }
      })).on(c.SPEAK_INVITE_REQ, (function (e, n) {
        if (r.isSelf(n.to)) switch (n.invite) {
          case 1:
            S || (p ? (t.cancelApply(), g(1)) : (S = !0, c.trigger(c.SPEAK_INVITE_CONFIRM)));
            break;
          case 0:
        ...
        if (!(r < 0)) {
          ...
          if (i) {
            ...
            1 === o ? c.trigger(c.SPEAK_INVITE_RESULT_ACCEPT, _) : 0 === o && c.trigger(c.SPEAK_INVITE_RESULT_REJECT, _)
          }
        }
      })).on(c.CLASSROOM_CONNECT_TRIGGER, (function (e, t) {
        t && (t.isClassSwitching || t.reconnect) && (p = !1, A = [], T = [])
      }))
    }, BJY.userSpeak = t
  },
  753: function (e, t, n) {
